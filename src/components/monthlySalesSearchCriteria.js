              ...
              {getFieldDecorator('currency', {
                ...
                <Select style={{ width: 170 }} placeholder='Select currency'>
                  {currencyList.map((value, index) => (
                    <Option key={value.CurrencyId} value={value.CurrencyCode}>
                      {value.CurrencyName}
                    </Option>
                  ))}
                </Select>
          ...
          {isSummaryContent && (
            <Form.Item label='Category'>
              {getFieldDecorator('category', {
                ...
                <Select style={{ width: 170 }} placeholder='Select category'>
...
const SearchCriteriaWrapper = Form.create({ name: 'coordinated' })(
  SearchCriteria
);
