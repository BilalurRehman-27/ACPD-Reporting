...
class UploadExcelInvoice extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      list: [],
  ...
  render() {
    const props = {
      name: 'file',
      action: ' http://52.151.114.149/ACPDReporting/api/Invoice/file/upload',
      headers: {
      ...
      <>
        <Layout>
          ...
          <Layout>
            ...
            >
              <h1>Upload Invoice ( Excel Only)</h1>
              <hr></hr>
              <Upload {...props}
                accept=".xlsx"
                showUploadList={true}
...
export default UploadExcelInvoice;
