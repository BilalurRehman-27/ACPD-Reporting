...
import qs from 'qs'
const LOGIN_URL = 'https://52.151.114.149/acpdreporting';
const DIRECT_SALES_BASE_URL = 'https://52.151.114.149/acpdreporting/api/DirectSales';
const INVOICES_BASE_URL = 'https://52.151.114.149/acpdreporting/api/invoice';
